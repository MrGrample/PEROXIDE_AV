...
namespace NoiseBall
{
    ...
    public class NoiseBallRenderer : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            _scaledNoiseAmplitude = _noiseAmplitude * audioPeer._audioBandBuffer[0];
            _scaledNoiseFrequency = _noiseFrequency * audioPeer._audioBandBuffer[0] + 0.2f;

            _materialProperties.SetFloat("_NoiseAmplitude", _scaledNoiseAmplitude);
            _materialProperties.SetFloat("_NoiseFrequency", _scaledNoiseFrequency);
